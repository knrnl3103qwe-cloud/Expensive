...
import expensive.events.EventChangeWorld;
import expensive.events.TickEvent;
import expensive.main.baritone.api.BaritoneAPI;
import expensive.main.baritone.api.IBaritone;
import expensive.main.baritone.api.event.events.WorldEvent;
import expensive.main.baritone.api.event.events.type.EventState;
import expensive.modules.api.FunctionRegistry;
import expensive.modules.impl.misc.SelfDestruct;
import expensive.modules.impl.player.ItemCooldown;
...
import expensive.main.viaversion.fixes.AttackOrder;
...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
     ...
     * JSON). Specified expensive.main.viaversion the
     ...
     * the version JSON). Specified expensive.main.viaversion the
    ...
    public void runTick() {
        ...
        if (this.currentScreen == null && this.player != null) {
            final BiFunction<EventState, expensive.main.baritone.api.event.events.TickEvent.Type, expensive.main.baritone.api.event.events.TickEvent> tickProvider = expensive.main.baritone.api.event.events.TickEvent.createNextProvider();

            for (IBaritone baritone : BaritoneAPI.getProvider().getAllBaritones()) {

                expensive.main.baritone.api.event.events.TickEvent.Type type = baritone.getPlayerContext().player() != null && baritone.getPlayerContext().world() != null
                        ? expensive.main.baritone.api.event.events.TickEvent.Type.IN
                        : expensive.main.baritone.api.event.events.TickEvent.Type.OUT;
