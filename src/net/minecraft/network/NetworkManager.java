...
import expensive.main.baritone.api.event.events.PacketEvent;
...
import expensive.main.viaversion.netty.handler.ViaDecoder;
import expensive.main.viaversion.netty.handler.ViaEncoder;
            ...
            protected void initChannel(Channel channel) {
                ...
                if (channel instanceof SocketChannel) {
                   ...
                   if (ViaLoadingBase.getInstance().getTargetVersion().getVersion() != Expensive.getInstance().getViaMCP().getNATIVE_VERSION()) {
                        channel.pipeline().addBefore("encoder", "expensive.main.viaversion-encoder", new ViaEncoder(user));
                        channel.pipeline().addBefore("decoder", "expensive.main.viaversion-decoder", new ViaDecoder(user));
                    }
                }
            }
