...
import expensive.main.viaversion.platform.viaversion.VLBViaAPIWrapper;
import expensive.main.viaversion.platform.viaversion.VLBViaConfig;
import expensive.main.viaversion.util.VLBTask;
...
public class ViaVersionPlatformImpl implements ViaPlatform<UserConnection> {
    ...
    public ViaVersionPlatformImpl(final Logger logger) {
        this.logger = logger;
        config = new VLBViaConfig(new File(ViaLoadingBase.getInstance().getRunDirectory(), "000ed75e600f609a9b7bc01076dc5ae8ce70dbe0"), logger);
    }
