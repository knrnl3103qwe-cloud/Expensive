...
package expensive.main.viaversion;

import expensive.main.viaversion.model.Platform;
import expensive.main.viaversion.platform.ViaBackwardsPlatformImpl;
import expensive.main.viaversion.platform.ViaRewindPlatformImpl;
import expensive.main.viaversion.platform.ViaVersionPlatformImpl;
import expensive.main.viaversion.platform.viaversion.VLBViaCommandHandler;
import expensive.main.viaversion.platform.viaversion.VLBViaInjector;
import expensive.main.viaversion.platform.viaversion.VLBViaProviders;
import expensive.main.viaversion.util.JLoggerToLog4j;
...
public class ViaLoadingBase {
    ...
    public ViaLoadingBase(LinkedList<Platform> platforms, File runDirectory, int nativeVersion, BooleanSupplier forceNativeVersionCondition, Supplier<JsonObject> dumpSupplier, Consumer<ViaProviders> providers, Consumer<ViaManagerImpl.ViaManagerBuilder> managerBuilderConsumer, Consumer<ProtocolVersion> onProtocolReload) {
        ...
        this.runDirectory = new File(runDirectory, "00");
