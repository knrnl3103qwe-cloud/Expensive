...
package expensive.main.baritone.api.utils.gui;
...
public class BaritoneToast implements IToast {
    ...
    public static void addOrUpdate(ITextComponent title, ITextComponent subtitle) {
        addOrUpdate(net.minecraft.client.Minecraft.getInstance().getToastGui(), title, subtitle, expensive.main.baritone.api.BaritoneAPI.getSettings().toastTimer.value);
    }
}
